...
import spacesheepgames.gocd.gcs.artifact.plugin.model.GCSFileArtifactPlanConfig;
...
public class GetPublishArtifactConfigMetadataExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() {
        final List<ConfigMetadata> metadata = MetadataHelper.getMetadata(GCSFileArtifactPlanConfig.class);
