...
import spacesheepgames.gocd.gcs.artifact.plugin.executors.*;

import java.util.Properties;

@Extension
public class GCSArtifactPlugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(GCSArtifactPlugin.class);
